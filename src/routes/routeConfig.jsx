...
export const routes = [
  ...
  // HOMEPAGE utk MANAGER = '/'
  { path: '/', element: <ManagerPerformanceDashboard />, roles: [ROLES.manager, ROLES.admin] },

  // (optional) Homepage utk Account Manager (Sales) kalau mau beda
  { path: '/am', element: <AccountManagerDashboard />, roles: [ROLES.sales] },

  // Fallback halaman pelanggan
