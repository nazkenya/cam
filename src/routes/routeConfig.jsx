...
export const routes = [
  ...
  // Account Manager (Sales) dashboard (kalau mau beda)
  { path: '/am', element: <AccountManagerDashboard />, roles: [ROLES.sales] },
  ...
  // (kalau Dashboard umum masih dipakai)
  // { path: '/dashboard', element: <Dashboard />, roles: [ROLES.admin, ROLES.manager, ROLES.sales] },
]
